...
model_filename = "mask_rcnn_pimiento_0010.h5"
class_names = ['BG','pimiento']
real_test_dir = 'test/'
min_confidence = 0.6

class PimientoConfig(Config):
...
config = PimientoConfig()
config.display()

class InferenceConfig(PimientoConfig):
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1
    #IMAGE_MIN_DIM = 512
    #IMAGE_MAX_DIM = 512
...
#Lo siguiente indica que dentro de la carpeta "logs" existira el archivo de los pesos
#mask_rcnn_pimiento_0010.h5 arriba solo se ha definido el nombre del archivo.
